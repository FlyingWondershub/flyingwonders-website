        ...
        <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '4rem', alignItems: 'center' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '1.1rem', lineHeight: 1.7, color: 'var(--text-dark)', opacity: 0.85 }}>
              With direct hotel partnerships, exclusive ground assets and a passionate team of travel architects, we turn every itinerary into a story worth telling. From iconic Singapore sights to hidden regional gems, Flying Wonders brings the destination to life.
            </p>
          </div>
