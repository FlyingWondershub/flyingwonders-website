...
export default function ShoppingMallsHubPage() {
  ...
  const filteredMalls = useMemo(() => {
    return DEFAULT_SHOPPING_MALLS.filter(mall => {
      const matchesSearch =
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem', flexWrap: 'wrap', gap: '0.5rem' }}>
          <div>
            ...
            <p style={{ fontSize: '0.84rem', color: '#64748B', margin: '3px 0 0' }}>
              Click any mall to access the complete visitor guide, brand directory, MRT map, and insider pro-tips.
            </p>
          </div>
        </div>
            ...
            {filteredMalls.map(mall => (
              ...
              >
                ...
                <div style={{ position: 'relative', height: '220px', width: '100%', overflow: 'hidden' }}>
                  ...
                  {/* Category Pill */}
                  <span style={{ position: 'absolute', top: '14px', left: '14px', background: 'rgba(15,23,42,0.8)', color: '#FFF', fontSize: '0.74rem', fontWeight: 700, padding: '4px 10px', borderRadius: '6px', backdropFilter: 'blur(6px)' }}>
                    {mall.category}
                  </span>
                ...
                <div style={{ padding: '1.25rem', display: 'flex', flexDirection: 'column', flex: 1 }}>
                  ...
                  <div style={{ background: '#F8FAFC', padding: '0.75rem', borderRadius: '10px', border: '1px solid #E2E8F0', marginTop: 'auto', marginBottom: '1.25rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '0.78rem', color: '#0F172A', marginBottom: '4px' }}>
                      ...
                      <strong>{mall.nearestMrt.station}</strong>
