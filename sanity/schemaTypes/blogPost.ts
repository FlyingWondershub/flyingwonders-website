export const blogPostSchema = {
  ...
  fields: [
    ...
    { name: 'date', title: 'Publish Date', type: 'date', validation: Rule => Rule.required() },
    { name: 'readTime', title: 'Read Time', type: 'string' },
    { name: 'imageUrl', title: 'Cover Image URL', type: 'url', validation: Rule => Rule.required() },
    { name: 'excerpt', title: 'Excerpt', type: 'text', validation: Rule => Rule.required() },
    { name: 'content', title: 'Content (Markdown)', type: 'text', validation: Rule => Rule.required() },
