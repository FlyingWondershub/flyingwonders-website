...
if attractions:
    first_sku = attractions[0]['sku_id']
    print(f"Fetching details for first SKU: {first_sku}")
    r4 = requests.get(f'{BASE}/attraction/details?sku_id={first_sku}', headers={'Authorization': f'BEARER {token}', 'X-API-Version': 'v1.10'})
